"""Django settings for Banxico project.
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "apps.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,
    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "apps.base.renderers.AppsApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "apps.users.auth.backends.UserTokenAuthentication",
...
SITE_NAME = env("SITE_NAME", default="Banxico")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="Banxico")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="panttojo@yandex.com")
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[Banxico] ")
...
DATABASES = {"default": env.db("DATABASE_URL", default="mysql://root:secret@localhost/db")}
